// cxb-autonew - Send /new (or /clear) command to a provider's terminal pane.
//
// Usage:
//
...
//
// Source: claude_code_bridge/bin/cxb-autonew
package main
...
func usage() {
	fmt.Fprintln(os.Stderr, "Usage: cxb-autonew <provider>")

// ccb-ping - Unified ping for AI providers.
//
// Usage:
//
//	ccb-ping <provider> [--session-file FILE] [--autostart]
//
// Source: claude_code_bridge/bin/ccb-ping
package main

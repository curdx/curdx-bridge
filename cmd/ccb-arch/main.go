// ccb-arch - Hippocampus Architecture Manager.
//
// Usage:
//
//	ccb-arch [snapshot [--force] | init]
//
// Source: claude_code_bridge/bin/ccb-arch
package main
...
func usage() {
	fmt.Println("usage: ccb-arch [-h] {snapshot,init} ...")
	fmt.Println()
...
func runSnapshot(force bool) {
	...
	fmt.Println("[INFO] Use the Python version: ccb-arch snapshot")
}

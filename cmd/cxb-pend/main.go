...
var providerPends = map[string]string{
	"gemini":   "cxb-gemini-pend",
	"codex":    "cxb-codex-pend",
	"opencode": "cxb-opencode-pend",
	"claude":   "cxb-claude-pend",
}

func usage() {
	fmt.Fprintln(os.Stderr, "Usage: cxb-pend <provider> [N] [--session-file FILE]")

...
Templates for common /cxb-task-run operations. Each template has a `_meta` section documenting placeholders.

## Usage

### Direct use (no placeholders)
```
/cxb-file-op <template content>
```
...
| verification | /cxb-review output.finalDecision.reason |

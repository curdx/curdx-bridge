---
name: cxb-continue
description: Attach the newest context-transfer Markdown from the current project's ./.curdx/history/ into Claude using @file. Use when the user types /cxb-continue or asks to resume with the latest transfer file in this project.
---
...
- `/cxb-continue` -> `@/home/bfly/workspace/hippocampus/.curdx/history/claude-20260208-225221-9f236442.md`

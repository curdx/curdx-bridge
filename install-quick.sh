...
install_claude_skills() {
  ...
  for obs in cask gask oask lask cpend gpend opend lpend cping gping oping lping ping auto tp tr all-plan ask pend autonew file-op mounted continue review; do
...
install_codex_skills() {
  ...
  # Clean obsolete skills
  for obs in cask gask oask lask cpend gpend opend lpend cping gping oping lping all-plan ask pend ping file-op mounted; do
    [[ -d "$dst/$obs" ]] && rm -rf "$dst/$obs"
  done
